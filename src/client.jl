...
Create a table in the database specified during authentication. This method signature is the Thrift-based method
and is not recommended for use unless you need the fine-grained control provided by the OmniSci backend code.
