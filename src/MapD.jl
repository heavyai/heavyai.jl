...
clear_gpu_memory, set_table_epoch, set_table_epoch_by_name, get_table_epoch,
get_table_epoch_by_name, sql_execute, sql_execute_df, sql_execute_gdf, deallocate_df,
...
import_table_status, get_first_geo_file_in_archive, get_all_files_in_archive, start_query,
execute_first_step, broadcast_serialized_rows, start_render_query, execute_next_render_step,
insert_data, checkpoint, get_table_descriptor, get_row_descriptor, get_roles,
get_db_objects_for_grantee, get_db_object_privs, get_all_roles_for_user, set_license_key,
get_license_claims
